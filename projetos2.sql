...
--
-- Host: 127.0.0.1
-- Tempo de geração: 27/03/2024 às 14:54
...
CREATE TABLE `banner` (
  `id` int(11) NOT NULL,
  `titulo` varchar(50) CHARACTER SET utf16 COLLATE utf16_general_ci DEFAULT NULL,
...
(1, 'Projetos', 'admin@gmail.com', '123', '(11)98765-4321', '', 'logo.png', 'icone.png', '', '', '', '', '', '#DAC8B3', NULL, NULL, NULL, NULL, NULL, NULL, 'Contate-nos', 'Preencha os Campos abaixo para entrar em contato conosco!', '');
