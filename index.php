    ...
    <div class="container">
      ...
      <div class="row wow fadeInUp">
        <div class="col-md-6 about-img">
          ...
          <?php } else { ?>
            <iframe class="video-mobile" width="100%" height="320px" src="<?php echo $video_sobre ?>" frameborder="0"
            ...
            <div id="carousel-service" class="service carousel slide">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-12 col-md-5">
                        <div class="screenshot wow bounceInRight">
                          ...
                          <?php } else { ?>
                            <iframe class="video-mobile" width="100%" height="320px" src="<?php echo $video ?>"
              ...
              <ol class="carousel-indicators">
                ...
                for ($i = 0; $i < $total_reg; $i++) {
                  ...
                  ?>
                  <li data-target="#carousel-service" data-slide-to="<?php echo $i ?>" class="<?php echo $active ?>"
                    onclick="new WOW().init();"></li>
                <?php } ?>
      ...
      <div class="row" style="margin-top: -70px">
        ...
        <div class="<?php echo $colunas ?>">
          <div class="contact-widget wow bounceInUp">
            <a target="_blank" href="http://api.whatsapp.com/send?1=pt_BR&phone=<?php echo $whatsapp_sistema ?>"
              class="link-neutro"><i class="fa fa-phone fa-4x"></i>
              <h5>Telefone / Whatsapp</h5>
            </a>
            <p>
              <a target="_blank" href="http://api.whatsapp.com/send?1=pt_BR&phone=<?php echo $whatsapp_sistema ?>"
                class="link-neutro" style="color:#2e2e2e"><?php echo $telefone_sistema ?></a>
            </p>
          </div>
        </div>
        <div class="<?php echo $colunas ?>">
